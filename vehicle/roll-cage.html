        ...
        <div class="container-fluid mt-sm-4">
            ...
            <p>The proses begun with a CAD model. With some work and calculations, 
                the process went forward. To get a grip on the real size of the model
                 ...
                 they fitted the chair in the mockup to see if the calculations where
                  right.   </p>
            <img src="/images/Carbonfiber-Vaccum.jpg" alt="..." class="img-thumbnail right">
            <p>To estimate the strength of the roll cage a FEM-analyses where done to the
